<div class="su-posts su-posts-default-loop">
	<?php
		...
		if ( $posts->have_posts() ) {
			while ( $posts->have_posts() ) :
				...
				<div id="su-post-<?php the_ID(); ?>" class="su-post">
					...
					<div class="su-post-meta"><?php _e( 'Postado', 'shortcodes-ultimate' ); ?>: <?php the_time( get_option( 'date_format' ) ); ?></div>
		...
		// Posts not found
			...
			echo '<h4>' . __( 'Nenhuma notícia encontrada', 'shortcodes-ultimate' ) . '</h4>';
		}
	?>
</div>